            ...
            <div class="px-4 py-5 sm:p-6">
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  ...
                  <dd class="mt-2">
                    <button type="button" @click="$router.push('/scenes/create')" class="inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                      创建新场景
                    </button>
                  </dd>
                </div>
